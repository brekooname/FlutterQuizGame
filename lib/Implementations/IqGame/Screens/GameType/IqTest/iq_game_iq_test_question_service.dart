...
class IqGameIqTestQuestionService extends QuestionService {
  static final IqGameIqTestQuestionService singleton =
      IqGameIqTestQuestionService.internal();

  factory IqGameIqTestQuestionService() {
    return singleton;
  }
