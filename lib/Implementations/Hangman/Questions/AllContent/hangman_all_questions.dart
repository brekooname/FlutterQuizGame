...
class HangmanAllQuestions extends AllQuestionsService {
  ...
  void addBG(Map<Language, Map<CategoryDifficulty, List<Question>>> result,
    ...
    addQuestions(
        ...
        ["Австрия", "Белгия", "Бразилия", "Канада", "Китай", "Франция", "Германия", "Италия", "Мексико", "Русия", "Испания", "Съединени щати", "Япония", "Австралия", "Португалия", "Турция", "България", "Индия", "Гърция"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat1, //
  ...
  void addCS(Map<Language, Map<CategoryDifficulty, List<Question>>> result,
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff4, //
        ["Pesto", "Rajčatová omáčka", "Švýcarský sýr", "Tortilla", "Baklava", "Kari", "Guacamole", "Bílá čokoláda", "Ocet", "Horká čokoláda", "Dim sum", "Těstoviny carbonara", "Rýžový nákyp", "Hovězí pečeně", "Čokoládový dort", "Zeleninová polévka", "Nudlová polévka", "Caesarův salát"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
  ...
  void addDA(Map<Language, Map<CategoryDifficulty, List<Question>>> result,
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff4, //
        ["Tomatsovs", "Schweizisk ost", "Baklava", "Karry", "Guacamole", "Hvid chokolade", "Eddike", "Varm chokolade", "Pasta carbonara", "Risengrød", "Roastbeef", "Chokoladekage", "Grøntsagssuppe", "Nuddel suppe", "Cæsar salat"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
  ...
  void addDE(Map<Language, Map<CategoryDifficulty, List<Question>>> result,
    ...
    addQuestions(
        ...
        questionConfig.cat0, //
        questionConfig.diff1, //
        ["Zypern", "Kolumbien", "Tschechien", "Kroatien", "Dänemark", "Ägypten", "Schweiz", "Finnland", "Ghana", "Marokko", "Iran", "Nigeria", "Serbien", "Norwegen", "Schweden", "Südkorea", "Ukraine", "Ungarn", "Algerien"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat1, //
        questionConfig.diff1, //
        ["Alligatoren", "Antilope", "Esel", "Nashörner", "Zebra", "Eisbär", "Ziege", "Schwein", "Gorilla", "Koala", "Kamel", "Hyäne", "Frosch", "Goldfisch", "Jaguar", "Schaf", "Wolf", "Schildkröte", "Pinguin"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat2, //
    ...
    addQuestions(
        ...
        questionConfig.cat1, //
        questionConfig.diff3, //
        ["Elch", "Kondor", "Vipern", "Falke", "Meerschweinchen", "Forelle", "Schakal", "Ratte", "Rentier", "Lama", "Schwan", "Fasan", "Fledermaus", "Lachs", "Skorpion", "Maultier", "Stinktier", "Gazelle", "Kojote"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat2, //
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff4, //
        ["Pesto", "Tomatensauce", "Müsli", "Emmentaler", "Tortilla", "Soufflee", "Curry", "Guacamole", "Essig", "Dim sum", "Spaghetti carbonara", "Milchreis", "Baumkuchen", "Muffin", "Schokoladenkuchen", "Gemüsesuppe", "Nudelsuppe", "Caesar Salad"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff5, //
        ["Hüttenkäse", "Paella", "Gnocchi", "Ratatouille", "Tortellini", "Linguine", "Tofu", "Cordon bleu", "Ahornsirup", "Hackfleisch", "Falafel", "Ricotta", "Eclair", "Hummus", "Tsatsiki", "Flan", "Antipasto", "Krautsalat", "Baklava"]);
  }
  ...
  void addEL(Map<Language, Map<CategoryDifficulty, List<Question>>> result,
    ...
    addQuestions(
        ...
        questionConfig.cat0, //
        questionConfig.diff0, //
        ["Αυστρία", "Βέλγιο", "Βραζιλία", "Κίνα", "Γαλλία", "Γερμανία", "Ιταλία", "Μεξικό", "Ρωσία", "Ισπανία", "Ιαπωνία", "Ολλανδία", "Αυστραλία", "Πορτογαλία", "Τουρκία", "Βουλγαρία", "Ινδία", "Ελλάδα"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat1, //
        questionConfig.diff0, //
        ["Ποντίκι", "Λεοπάρδαλη", "Δελφίνι", "Κοράκι", "Ελάφι", "Κουνέλι", "Τίγρη", "Περιστέρι", "Πάπια", "Καμηλοπάρδαλη", "Λιοντάρι", "Αρκούδα", "Αλογο"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat2, //
    ...
    addQuestions(
        ...
        questionConfig.cat3, //
        questionConfig.diff0, //
        ["Ποδιά", "Μπουκάλι", "Ανοιχτήρι μπουκαλιών", "Γαβάθα", "Μαχαιρικά είδη", "Πιρούνι"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat4, //
        questionConfig.diff0, //
        ["Ντόνατ", "Ζυμαρικά", "Κεμπάπ", "Κρουασάν", "Λαζάνια", "Τυρί", "Πίτσα", "Μακαρόνια", "Ομελέτα", "Παγωτό", "Ψωμί", "Κέικ", "Ψητό", "Γιαούρτι", "Γρήγορο φαγητό", "Τυριά", "Σιρόπι από σφένδαμο", "Τοστ", "Σοκολάτα"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
        questionConfig.diff1, //
        ["Κολομβία", "Τσεχική Δημοκρατία", "Κροατία", "Δανία", "Ελβετία", "Φινλανδία", "Γκάνα", "Μαρόκο", "Ιράν", "Νιγηρία", "Σερβία", "Νορβηγία", "Λευκορωσία", "Σουηδία", "Νότια Κορέα", "Ουκρανία", "Ουγγαρία", "Αλγερία"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat1, //
        questionConfig.diff1, //
        ["Αντιλόπη", "Ζέβρα", "Πολική αρκούδα", "Γίδα", "Φάλαινα", "Καμήλα", "Υαινα", "Χρυσόψαρο", "Πρόβατο", "Χελώνα"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat2, //
        questionConfig.diff1, //
        ["Τουλίπα", "Κρεμμύδι", "Κεράσια", "Κολοκύθι", "Πικραλίδα", "Φιστίκια", "Τσουκνίδα", "Βερύκοκκο", "Καρύδα", "Φράπα", "Καρπούζι", "Πεπόνι", "Βύσσινα", "Μέντα", "Λάχανο"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat3, //
        questionConfig.diff1, //
        ["Πλυντήριο πιάτων", "Φαγητό", "Αποχυμωτή", "Συνταγή"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat4, //
        questionConfig.diff1, //
        ["Φυστικοβούτυρο", "Πουτίγκα", "Κεφτεδάκια", "Ψητό κοτόπουλο", "Μέλι", "Θαλασσινά", "Λουκάνικα", "Χάμπουργκερ", "Μαγιονέζα", "Ποπ κορν", "Τσίσμπεργκερ", "Λουκάνικο", "Κεκάκι", "Μπέικον", "Κέτσαπ", "Βούτυρο", "Τηγανίτα"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
    ...
    addQuestions(
        ...
        questionConfig.cat1, //
        questionConfig.diff2, //
        ["Χήνα", "Καγκουρώ", "Χάμστερ", "Σκαθάρι", "Πανθήρ", "Χταπόδι", "Πύθων", "Κουνάβι", "Καφέ αρκούδα"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat2, //
        questionConfig.diff2, //
        ["Κυδώνι", "Ραπανάκι", "Παντζάρι", "Κακάο", "Ακτινίδια", "Μάνγκο", "Χρένο", "Εικ", "Ρίγανη", "Ελατο", "Φραγκοστάφυλα", "Μελιτζάνα", "Οξυάκανθα", "Ελιά", "Μπρόκολο", "Ανηθο", "Σπανάκι", "Κουνουπίδι"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat3, //
        questionConfig.diff2, //
        ["Τηγάνι", "Τραπέζι", "Φρυγανιέρα", "Σουρωτήρι", "Σπαθί"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat4, //
        questionConfig.diff2, //
        ["Κομπόστα", "Ελαιόλαδο", "Ραβιόλι", "Χοιρινή μπριζόλα", "Κοτόσουπα", "Τσεισκέικ", "Αμυγδαλωτό", "Ρολό κιμά", "Μαύρη σοκολάτα", "Μελόπιτα", "Φλυαρώ", "Μπαρμπεκιου"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
        questionConfig.diff3, //
        ["Ανδόρα", "Αγκόλα", "Αρμενία", "Βόρεια Κορέα", "Ινδονησία", "Χιλή", "Λιθουανία", "Μαλαισία", "Μάλι", "Μαυροβούνιο", "Σενεγάλη", "Παραγουάη", "Λουξεμβούργο", "Ουρουγουάη", "Βενεζουέλα", "Ιράκ", "Κούβα"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat1, //
        questionConfig.diff3, //
        ["Κόνδωρ", "Οχιά", "Γεράκι", "Ινδικό χοιρίδιο", "Μαυρο μαμπα", "Μέδουσα", "Ορτύκι", "Μουλάρι"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat2, //
        questionConfig.diff3, //
        ["Βαμβάκι", "Σφεντάμι", "Λεύκα", "Κλεμεντίνη", "Ρύζι", "Αβοκάντο", "Μαύρο πιπέρι", "Σέλινο", "Μαρούλι", "Μουστάρδα", "Θυμάρι"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat3, //
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff3, //
        ["Πατατοσαλάτα", "Κρέμα καραμελέ", "Κολοκυθόπιτα", "Στιφάδο", "Αγγουράκια τουρσί", "Κουλουράκι", "Κουκούτσι", "Μοτσαρέλα", "Παρμεζάνα", "Τηγανιτό ρύζι", "Μπισκότα", "Σούσι", "Μηλόπιτα"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
        questionConfig.diff4, //
        ["Αφγανιστάν", "Σαουδική Αραβία", "Ακτή Ελεφαντοστού", "Μπαχρέιν", "Κόστα Ρίκα", "Ελ Σαλβαδόρ", "Κενύα", "Γουατεμάλα", "Ονδούρα", "Ιορδανία", "Λιβερία", "Σιγκαπούρη", "Γέμενη", "Μάλτα", "Βατικανό"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat1, //
        questionConfig.diff4, //
        ["Τσακάλι", "Βιζόν", "Κόκκινο πάντα", "Σαλαμάνδρα", "Αηδόνι", "Βίδρα", "Ρέγγα"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat2, //
        questionConfig.diff4, //
        ["Αλόη", "Φτέρη", "Κάστανο", "Σημύδα", "Κλήθρα", "Ραβέντι", "Χουρμαδιά", "Σπαράγγι", "Παλάμη", "Γαρύφαλλο", "Λινάρι", "Μπάμια", "Τριφύλλι", "Γκι", "Μαγνολία", "Λευκόιο"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat3, //
        questionConfig.diff4, //
        ["Καράφα", "Διηθητήριο", "Σαπούνι", "Σφουγγάρι", "Κουτάλι"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat4, //
        questionConfig.diff4, //
        ["Πέστο", "Μούσλι", "Ελβετικό τυρί", "Μπακλάβα", "Κάρι", "Λευκή σοκολάτα", "Ξύδι", "Ζεστή σοκολάτα", "Ριζόγαλο", "Ψητό βοδινό", "Σοκολατένιο κέικ", "Χορτόσουπα", "Νούτλ σούπα", "Σαλάτα του Καίσαρα"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
        questionConfig.diff5, //
        ["Αντίγκουα και Μπαρμπούντα", "Μπρουνέι", "Μπουρούντι", "Αιθιοπία", "Γκάμπια", "Καζακστάν", "Λιχτενστάιν", "Μαδαγασκάρη", "Σαν Μαρίνο", "Συρία", "Σομαλία", "Σουδάν", "Τόγκο", "Ουγκάντα", "Ζάμπια", "Ζιμπάμπουε", "Μπενίν"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat1, //
        questionConfig.diff5, //
        ["Ρακούν", "Σφυραίνα", "Καρακάξα", "Ψαρόνι"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat2, //
        questionConfig.diff5, //
        ["Γλυκάνισο", "Μαργαρίτα", "Ρόδι", "Μπαμπού", "Σιτάρι", "Λαχανάκια Βρυξελλών", "Ρεβύθια", "Αντίρριο", "Ανεμώνη", "Παπάγια", "Μάραθο", "Δενδρολίβανο", "Χρυσάνθεμο", "Τζίντζερ"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat3, //
        questionConfig.diff5, //
        ["Κουζίνα", "Μαχαίρι", "Χαρτοπετσέτα", "Ψυγείο", "Τσαγιέρα", "Θερμόμετρο"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat4, //
        questionConfig.diff5, //
        ["Τυροκομείο", "Ρατάτουιλ", "Τορτελίνι", "Κεφίρ", "Σάλτσα Τζατζίκι", "Τιραμισού", "Ιταλικό ορεκτικό", "Σάλτσα"]);
  }
  ...
  void addFI(Map<Language, Map<CategoryDifficulty, List<Question>>> result,
    ...
    addQuestions(
        ...
        questionConfig.cat0, //
        questionConfig.diff1, //
        ["Kypros", "Kolumbia", "Kroatia", "Tanska", "Egypti", "Sveitsi", "Suomi", "Ghana", "Marokko", "Iran", "Nigeria", "Serbia", "Norja", "Valko-Venäjä", "Ruotsi", "Etelä-Korea", "Ukraina", "Unkari", "Algeria"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat1, //
  ...
  void addHR(Map<Language, Map<CategoryDifficulty, List<Question>>> result,
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff3, //
        ["Krumpir salata", "Kremna karamela", "Knedla", "Pita od bundeve", "Sufle", "Sendvič sa sirom", "Paprikaš", "Pereca", "Kuskus", "Sir na žaru", "Mozzarella", "Parmezan", "Pržena riža", "Keksi", "Sushi", "Pita od jabuka", "Riba i čips"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff4, //
        ["Umak od rajčice", "Muesli", "Švicarski sir", "Tortilja", "Baklava", "Guacamole", "Bijela čokolada", "Ocat", "Vruća čokolada", "Dim sum", "Karbonara od tjestenine", "Puding od riže", "Pečena govedina", "Kolač", "Čokoladna torta", "Juha od povrća", "Juha od rezanci", "Cezar salata"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
    ...
    addQuestions(
        ...
        questionConfig.cat2, //
        questionConfig.diff5, //
        ["Anis", "Bonsai", "Tratinčica", "Nar", "Bambus", "Pšenica", "Briselske klice", "Slanutak", "Sekvoja", "Zijevalica", "Venerina muholovka", "Anemona", "Papaja", "Komorač", "Paškanat", "Grejpfrut", "Ruzmarin", "Hrizantema", "Đumbir"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat3, //
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff5, //
        ["Posni sir", "Paella", "Njoki", "Ratatouille", "Tortelini", "Tofu", "Plava traka", "Kefir", "Mljevena junetina", "Falafel", "Ricotta", "Umak Tzatziki", "Tiramisu", "Krumpir krumpira", "Štrudla"]);
  }
  ...
  void addNB(Map<Language, Map<CategoryDifficulty, List<Question>>> result,
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff4, //
        ["Pesto", "Tomatsaus", "Sveitsisk ost", "Tortilla", "Baklava", "Karri", "Guacamole", "Hvit sjokolade", "Eddik", "Varm sjokolade", "Dim sum", "Pasta carbonara", "Risgrøt", "Roastbiff", "Muffin", "Sjokoladekake", "Grønnsakssuppe", "Nudelsuppe", "Cæsarsalat"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
  ...
  void addSL(Map<Language, Map<CategoryDifficulty, List<Question>>> result,
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff4, //
        ["Pesto", "Paradižnikova omaka", "Švicarski sir", "Kari", "Bela čokolada", "Kis", "Vroča čokolada", "Testenine carbonara", "Rižev puding", "Goveja pečenka", "Čokoladna torta", "Zelenjavna juha", "Juha z rezanci", "Cezarjeva solata"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
  ...
  void addSR(Map<Language, Map<CategoryDifficulty, List<Question>>> result,
    ...
    addQuestions(
        ...
        questionConfig.cat0, //
        questionConfig.diff0, //
        ["Аустрија", "Белгија", "Бразил", "Канада", "Кина", "Француска", "Немачка", "Италија", "Мексико", "Русија", "Спаин", "Америка", "Јапан", "Аустралија", "Португал", "Турска", "Бугарска", "Индија", "Грчка"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat1, //
  ...
  void addTR(Map<Language, Map<CategoryDifficulty, List<Question>>> result,
    ...
    addQuestions(
        ...
        questionConfig.cat0, //
        questionConfig.diff0, //
        ["Avusturya", "Belçika", "Brezilya", "Kanada", "Çin", "Fransa", "Almanya", "Meksika", "Rusya", "Ispanya", "Amerika Birleşik Devletleri", "Japonya", "Hollanda", "Avustralya", "Portekiz", "Türkiye", "Bulgaristan", "Hindistan", "Yunanistan"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat1, //
    ...
    addQuestions(
        ...
        questionConfig.cat0, //
        questionConfig.diff1, //
        ["Kıbrıs", "Kolombiya", "Çek Cumhuriyeti", "Hırvatistan", "Danimarka", "Finlandiya", "Gana", "Fas", "Nijerya", "Sırbistan", "Norveç", "Belarus", "Güney Kore", "Ukrayna", "Macaristan", "Cezayir"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat1, //
    ...
    addQuestions(
        ...
        questionConfig.cat0, //
        questionConfig.diff2, //
        ["Bolivya", "Kamerun", "Güney Afrika", "Romanya", "Ekvador", "Estonya", "Peru", "Letonya", "Slovakya", "Slovenya", "Polonya", "Tunus", "Arjantin", "Vietnam", "Gürcistan", "Arnavutluk", "Monako", "Nepal"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat1, //
    ...
    addQuestions(
        ...
        questionConfig.cat1, //
        questionConfig.diff3, //
        ["Engerek", "Şahin", "Gine domuzu", "Alabalık", "Siyah mamba", "Deniz anası", "Ren geyiği", "Kuğu", "Sülün", "Bıldırcın", "Somon", "Akrep", "Katır", "Kokarca", "Çakal"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat2, //
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff3, //
        ["Patates salatası", "Krem Karamel", "Meyveli börek", "Balkabağı pastası", "Sufle", "Peynirli sandviç", "Güveç", "Çubuk kraker", "Kuskus", "Izgara peynir", "Parmesan Peyniri", "Kızarmış pirinç", "Bisküvi", "Suşi", "Elmalı turta"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff4, //
        ["Pesto", "Domates sosu", "Isviçre peyniri", "Tortilla", "Baklava", "Köri", "Guacamole", "Beyaz çikolata", "Sirke", "Sıcak çikolata", "Dim toplamı", "Makarna Carbonara", "Sütlaç", "Dana rosto", "Çikolatalı kek", "Sebze çorbası", "Şehriye çorbası", "Sezar salatası"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
    ...
    addQuestions(
        ...
        questionConfig.cat2, //
        questionConfig.diff5, //
        ["Anason", "Bonsai", "Papatya", "Bambu", "Buğday", "Brüksel lahanası", "Nohut", "Sekoya", "Aslanağzı", "Anemon", "Papaya", "Rezene", "Yaban havucu", "Biberiye", "Krizantem", "Zencefil"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat3, //
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff5, //
        ["Süzme peynir", "Ratatouille", "Tortellini", "Şavurma", "Soya peyniri", "Cordon Bleu", "Kefir", "Dana kıyma", "Falafel", "Cacık Sosu", "Tiramisu", "Patates dilimleri", "Antipsto"]);
  }
  ...
  void addUK(Map<Language, Map<CategoryDifficulty, List<Question>>> result,
    ...
    addQuestions(
        ...
        questionConfig.cat2, //
        questionConfig.diff1, //
        ["Тюльпан", "Цибуля", "Вишні", "Гарбуз", "Кава", "Кульбаба", "Ананас", "Арахіс", "Кропива", "Абрикос", "Кокосовий горіх", "Грейпфрут", "Кавун", "Диня", "Вишня", "Перець", "Капуста", "Горох"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat3, //
    ...
    addQuestions(
        ...
        questionConfig.cat1, //
        questionConfig.diff2, //
        ["Гуска", "Барсук", "Кабан", "Лелека", "Кенгуру", "Анаконда", "Білка", "Папуга", "Хом'як", "Їжак", "Бегемот", "Жук", "Пантера", "Восьминіг", "Пітон", "Бабуїн", "Бурий ведмідь", "Пелікан", "Ворон"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat2, //
    ...
    addQuestions(
        ...
        questionConfig.cat4, //
        questionConfig.diff2, //
        ["Компот", "Мусака", "Пастрамі", "Оливкова олія", "Равіолі", "Молочний коктейль", "Свиняча відбивна", "Курячий суп", "Чізкейк", "Французький тост", "Марципан", "Гуляш", "Буріто", "Темний шоколад", "Макарони", "Пряники", "Вафлі", "Барбекю"]);
    addQuestions(
        result, //
        language, //
        questionConfig.cat0, //
